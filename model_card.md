...
**Document Your Evaluation: Comparing the profiles**


**High-Energy Pop vs. Chill Lofi:** The Pop profile pulls fast, upbeat songs while the Lofi profile pulls slow, mellow ones — this makes sense because the two profiles asked for opposite energy levels, so the recommender correctly sorted by how calm or hyped each song feels.

**High-Energy Pop vs. Deep Intense Rock:** Both profiles want high energy, so they actually share a couple of songs (like "Gym Hero" and "Riot Static") — the difference is mood and genre, with Rock favoring loud, aggressive tracks and Pop favoring upbeat, happy-leaning ones.

**Chill Lofi vs. Deep Intense Rock:** These two are almost total opposites in the results — Lofi wants quiet, acoustic, relaxed songs and Rock wants loud, electric, intense ones, so almost nothing overlaps between them.
